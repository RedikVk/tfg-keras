...
\item A principios de los años 40, el neurólogo Warren McCulloch y el matemático Walter Pitts propusieron el primer modelo matemático de redes neuronales. Describieron como funcionaban las neuronas, y modelaron un red neuronal simple usando circuitos eléctricos.
...
\subsection {La neurona biológica} \mbox{}\\
...
\end{figure}
\\Las capacidades de decisión de un perceptrón multicapa de 2 y 3 capas con una única neurona de salida se muestran en la figura \ref{tablaperceptron}:
\begin{figure}[htp]
\centering
\includegraphics[scale=0.7]{images/perceptron23capas.png}
\label{tablaperceptron}
